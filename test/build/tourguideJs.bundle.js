	...
	var umbrella_min = createCommonjsModule(function (module) {
		...
		var u = function u(t, e) {
			...
			return "number" == typeof t && (t = 0 === t ? [] : new Array(t).join().split(",").map(Number.call, Number)), this.each(function (r, o) {
				var e = document.createDocumentFragment();u(t || {}).map(function (t, e) {
					var n = "function" == typeof i ? i.call(this, t, e, r, o) : i;return "string" == typeof n ? this.generate(n) : u(n);
				}).each(function (t) {
			...
			o = o;var i = this;return this.nodes.reduce(function (t, e, n) {
				var r;return o ? ((r = o.call(i, e, n)) || (r = !1), "string" == typeof r && (r = u(r)), r instanceof u && (r = r.nodes)) : r = e.innerHTML, t.concat(!1 !== r ? r : []);
			}, []);
			...
			return this.map(function (t, e) {
				var n = t.cloneNode(!0),
				    r = this.getAll(n);return this.getAll(t).each(function (t, e) {
			...
			}, this);return this.on.apply(this, t);
			...
			if ("string" == typeof e) {
				var o = e;e = function e(_e) {
					var n = arguments;u(_e.currentTarget).find(o).each(function (t) {
						if (t === _e.target || t.contains(_e.target)) {
							try {
								Object.defineProperty(_e, "currentTarget", { get: function get() {
										return t;
									} });
							} catch (t) {}r.apply(t, n);
						}
			...
			if (void 0 !== t) {
				var o = n;(n = {})[o] = t;
			}return "object" == (typeof n === "undefined" ? "undefined" : _typeof2(n)) ? this.each(function (t) {
				for (var e in n) {
					r(t, e, n[e]);
				}
			...
			var n = [];return this.adjacent(t, e, function (t, e) {
			...
			var r = this;return this.slice(this.first().elements).reduce(function (e, n) {
			...
			var o = this.slice(arguments).slice(1);return this.eacharg(t, function (t, e) {
				var n,
				    r = { bubbles: !0, cancelable: !0, detail: o };try {
